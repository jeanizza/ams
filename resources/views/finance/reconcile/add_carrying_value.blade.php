...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Add Accumulated Depreciation and Carrying Value</div>
                <div class="card-body">
                    ...
                    <!-- Disposal Value Form -->
                    <form id="disposalForm" action="{{ route('finance.store_carrying_value') }}" method="POST">
                        @csrf
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function fetchFilteredData() {
        ...
        let url = "{{ route('finance.add_carrying_value') }}";
