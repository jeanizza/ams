                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <select class="form-control" id="category" name="category">
                                <option value="" disabled {{ !$serviceable->category ? 'selected' : '' }}>Select a category</option>
                                @php
                                    $categories = [
                                        "05-Agricultural & Forestry Equipment",
                                        "05-Buildings",
                                        "05-Communication Equipment",
                                        "05-Construction Equipment",
                                        "06-Furniture & Fixtures",
                                        "05-Information & Communication Technology Equipment (ICT)",
                                        "05-Marine & Fishery Equipment",
                                        "05-Office Equipment",
                                        "05-Other Land Improvements",
                                        "05-Sports Equipment",
                                        "05-Technical & Scientific Equipment",
                                        "06-Transportation Equipment",
                                        "05-Watercrafts Equipment"
                                    ];
                                @endphp
                                @foreach ($categories as $category)
                                    <option value="{{ $category }}" {{ trim($serviceable->category) == trim($category) ? 'selected' : '' }}>
                                        {{ $category }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="amount" name="amount" value="{{ number_format($serviceable->amount, 2) }}" data-raw-value="{{ $serviceable->amount }}">
                            @error('amount')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        amountInput.addEventListener('input', function(e) {
            ...
            if (rawValue) {
                e.target.value = parseFloat(rawValue).toLocaleString('en-US', { 
        ...
        // Ensure raw value is sent on form submission
